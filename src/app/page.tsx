		...
		<PageLayout bgColor={PAGE_COLORS.HOME_PAGE}>
			<div className={styles.container}>
				<TextBlock
					...
					paragraph="В последние годы количество пластикового мусора в нашей стране растет. По статистике, жители Абхазии производят в&nbsp;среднем более 20&nbsp;тыс. тонн пластиковых отходов в год, и&nbsp;это&nbsp;число продолжает увеличиваться. Большая часть отходов пластика оказывается на свалках, что негативно сказывается на&nbsp;экосистеме нашей страны."
				/>
				<EnterComposition />
				<TextBlock
				...
				<TextBlock
					title="Мы собираем пластиковый&nbsp;мусор, сортируем его и&nbsp;перерабатываем, создавая&nbsp;[[совершенно новые]][[ ]][[изделия]]."
